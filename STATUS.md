...
- Se in futuro si vorrà una vera automazione via API Gemini (nessuna azione richiesta finché non viene chiesto esplicitamente): servirà una chiave API con billing abilitato, una decisione su dove custodirla e sul trigger (script manuale, GitHub Action, o nello scraper `bikestylemag-idea`).
